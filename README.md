# FRONTEND AND BACKEND BOTH ARE RENDER THROUGH SAME SERVER DUE TO WHICH THE LOAD ON SERVER INCREASES,EXTRA HTML,CSS AND JS SEND FOR EACH DIFFRENT PAGE OF WEBSITE THOUGH THEY SAME SAME COMPONENTS FEATURES SAME
